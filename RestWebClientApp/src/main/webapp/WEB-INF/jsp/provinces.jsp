...
<html>
    ...
    <body>
        ...
        <table  class="table table-striped" id="id_js_provinces">
            <thead>
                <tr>
                    <th>Kode</th>
                    <th>Nama</th>
            ...
            <tbody>
                <c:forEach items="${provinces}" var="province">
                    <tr>
                        ...
                        <td><a href="<c:url value="regenciesByProvince.php?id=${province.getId()}"/>">${province.getName()}</a></td>
                        <td>
                            <a href="#">Ubah</a>
                            |
                            <a href="#">Hapus</a>
        ...
        <c:otherwise>
            <font color="red">Data Provinsi masih kosong !</font>
        </c:otherwise>
        </c:choose>
        </div>
    </body>
